...
public class RepositoryApiKeySecretHasher {
    private final byte[] pepper;

    public RepositoryApiKeySecretHasher(String pepper) {
    ...
    public boolean matches(String plaintextKey, String expectedHash) {
